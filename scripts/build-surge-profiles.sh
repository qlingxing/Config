...
MANAGED_CONFIG_BASE_URL=https://raw.githubusercontent.com/qlingxing/Config/main/Surge
...
build_profile() {
...

  {
    ...
    printf '%s\n' "# $title"
    printf '%s\n' '# Put device-specific nodes and MITM certificate material in an editable copy.'
    printf '\n'
