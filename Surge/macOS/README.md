...
each selector after adding nodes or a subscription. Its base rules are local
only; add remote rulesets or modules from Surge after the profile is imported.
